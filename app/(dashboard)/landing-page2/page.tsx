...
export default function LandingPage2() {
  ...
  return (
    <>
      ...
      <FeaturesSection content={content} fallbackCards={DEFAULT_CONTENT.features.cards} />
      <FullOverviewSection content={content} />
      <SupportSection content={content} />
      <PricingSection content={content} fallbackPlans={DEFAULT_CONTENT.pricing.plans} />
